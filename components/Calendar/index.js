...
class Calendar extends React.Component{
    ...
    makeFirestoreRequest() {
        let daysInMonth = new Date(this.state.year, this.state.month + 1, 0).getDate(); // Days in the current month (28 - 31)
        ...
        // Database query
        let query = journalRef.where('date', '>=', startDate).where('date', '<=', endDate);
        ...
        return(
            <View>
                <View style={styles.buttonContainer}>
                    <Pressable style={styles.nextPrevBtn}
