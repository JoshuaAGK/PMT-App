...
function shuffleAnswers(answers) { // https://stackoverflow.com/questions/2450954/how-to-randomize-shuffle-a-javascript-array
    ...
    if (index == -1) {
        return (
          <View style={styles.brainTraining}>
            ...
            <Pressable style={[mainStyles.platformShadow, styles.beginGameButton]} onPress={() => beginGame()}>
        ...
        let answers = shuffleAnswers([dictionary[word]["incorrect0"], dictionary[word]["incorrect1"], dictionary[word]["incorrect2"], dictionary[word]["correct"]]);
        ...
        return (
            ...
            <View style={styles.interaction}>
                ...
                <View style={styles.buttons}> 
                    <Pressable style={styles.button} onPress={() => answerQuestion(answer1)}>
                        <Text style={styles.buttonText}>{answer1}</Text>
                    </Pressable>
                    <Pressable style={styles.button} onPress={() => answerQuestion(answer2)}>
                        <Text style={styles.buttonText}>{answer2}</Text>
                    </Pressable>
                    <Pressable style={styles.button} onPress={() => answerQuestion(answer3)}>
                        <Text style={styles.buttonText}>{answer3}</Text>
                    </Pressable>
                    <Pressable style={styles.button} onPress={() => answerQuestion(answer4)}>
