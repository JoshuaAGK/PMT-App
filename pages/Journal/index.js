    ...
    getUserCollection('journal')
      ...
      .then(async () => {
        ...
        await incrementBalance(
          currentBalance,
          points.JOURNAL_SUBMISSION_POINTS
        );
        dispatch(setText(''));
        dispatch(setMood(-1));
      })
    ...
    >
      ...
      <View style={journalStyles.journalHeader}>
        ...
        <View style={mainStyles.buttonContainer}>
          <Pressable
            style={[mainStyles.button, journalStyles.calendarButton]}
      ...
      <Formik
        initialValues={{ emotionTracker: -1, text: '' }}
        ...
        {({
          ...
          <View style={mainStyles.container}>
            ...
            <View style={mainStyles.buttonErrorContainer}>
              ...
              <View
                style={[mainStyles.buttonErrorContainer, styles.errorBoxStyle]}
              >
                {errors.text && touched.text ? (
                  <Text style={styles.errorStyle}>{errors.text}</Text>
                ) : null}
                {errors.emotionTracker && touched.emotionTracker ? (
                  <Text style={styles.errorStyle}>{errors.emotionTracker}</Text>
                ) : null}
              </View>
            </View>
          </View>
      ...
      <Text style={[mainStyles.bigText, journalStyles.title]}>
        Daily Activity
      </Text>

      <View
        style={[
          journalStyles.dailyActivityList,
      ...
      >
        {ACTIVITIES.map((el, index) => renderItem(el, index))}
      </View>
    </ScrollView>
  );
};
